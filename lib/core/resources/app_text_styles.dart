...
class AppTextStyles {
  ...
  static get textStyle22headlineMedium600 => baseFont.copyWith(
        color: ColorManager.textPrimary,
        fontSize: 22.sp,
        fontWeight: FontWeight.w600,
      );
  static get textStyle14labelMedium600Pink => baseFont.copyWith(
        color: ColorManager.pinkSherbet,
        fontSize: 14.sp,
        fontWeight: FontWeight.w600,
      );
       static get textStyle14labelMedium600hints => baseFont.copyWith(
